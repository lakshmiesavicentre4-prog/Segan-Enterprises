  ...
  return (
    <footer className="bg-[#020617] border-t-8 border-[#F59E0B] text-blue-200 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Top Segment */}
        <div className="flex flex-col md:flex-row justify-between gap-8 mb-10 pb-10 border-b border-[#F59E0B]/20">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm font-semibold text-blue-100 max-w-2xl leading-relaxed border-l-2 border-[#F59E0B] pl-3">
          ...
          <div className="flex flex-col justify-center items-start md:items-end space-y-4 text-xs font-bold text-blue-100 uppercase tracking-widest text-left md:text-right">
            <h4 className="border-b-2 border-[#F59E0B] pb-1 inline-block text-white">Contact Support</h4>
            <a href="mailto:seganatoz@gmail.com" className="flex items-center space-x-2 hover:text-[#F59E0B] transition-colors">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] font-bold text-blue-300 uppercase tracking-widest">
          ...
          <div className="flex items-center space-x-6 flex-wrap justify-center gap-y-2">
            <button onClick={() => setView('contact')} className="hover:text-[#F59E0B] transition-colors focus:outline-none">Contact Us</button>
            <button onClick={() => setView('terms')} className="hover:text-[#F59E0B] transition-colors focus:outline-none">Terms & Conditions</button>
            <button onClick={() => setView('refunds')} className="hover:text-[#F59E0B] transition-colors focus:outline-none">Refunds & Cancellations</button>
            <button onClick={() => setView('privacy')} className="hover:text-[#F59E0B] transition-colors focus:outline-none">Privacy Policy</button>
          </div>
        </div>
