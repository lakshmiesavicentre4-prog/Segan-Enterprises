...
const AppContent: React.FC = () => {
  ...
  const renderCurrentView = () => {
    ...
    if (settings.maintenanceMode && currentUser?.role !== 'super_admin') {
      return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-slate-50 dark:bg-slate-950 min-h-[60vh] space-y-4">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-350 select-none transition-colors duration-300">
      <Navbar />
