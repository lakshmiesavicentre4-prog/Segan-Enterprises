...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-700 dark:text-slate-350 select-none transition-colors duration-300 w-full overflow-x-hidden">
      <Navbar />
