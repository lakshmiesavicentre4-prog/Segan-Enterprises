...
export const AuthPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col flex-1 justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[#f4f7f6] dark:bg-[#020617] transition-colors duration-300 relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-5 pointer-events-none"></div>
      <div className="max-w-md w-full mx-auto space-y-6 relative z-10">
        
        {/* Top Header */}
        <div className="text-center space-y-2">
          <div className="mx-auto flex h-24 w-24 md:h-28 md:w-28 items-center justify-center animate-fade-in bg-white p-2 rounded-full shadow-lg border-2 border-white ring-4 ring-[#F59E0B]">
        ...
        {/* Auth Block */}
        <div className="bg-white dark:bg-[#0F172A] border border-slate-300 dark:border-slate-700 p-6 md:p-8 rounded-sm shadow-xl text-left border-t-4 border-t-[#F59E0B]">
