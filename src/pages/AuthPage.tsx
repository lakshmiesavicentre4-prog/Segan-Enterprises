...
export const AuthPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col flex-1 justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[#f4f7f6] dark:bg-[#0c0a09] transition-colors duration-300 relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-5 pointer-events-none"></div>
      <div className="max-w-md w-full mx-auto space-y-6 relative z-10">
        
        {/* Top Header */}
        <div className="text-center space-y-2">
          <div className="mx-auto flex h-24 w-24 md:h-28 md:w-28 items-center justify-center animate-fade-in bg-white p-2 rounded-full shadow-lg border-2 border-white ring-4 ring-[#FFAE00]">
            <img src="/logo1.png" alt="Logo" className="w-full h-full object-contain rounded-full" />
          </div>
          <h2 className="font-display font-black text-2xl md:text-3xl text-[#1a2b56] dark:text-blue-200 tracking-tight mt-6 uppercase">
        ...
        {/* Auth Block */}
        <div className="bg-white dark:bg-[#1a2b56] border border-slate-300 dark:border-slate-700 p-6 md:p-8 rounded-sm shadow-xl text-left border-t-4 border-t-[#FFAE00]">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-4 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-800 dark:text-white font-bold text-sm rounded shadow-sm cursor-pointer flex items-center justify-center space-x-3 transition active:scale-95 group hover:border-[#1a2b56] dark:hover:border-blue-400"
            >
