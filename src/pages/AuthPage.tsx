...
export const AuthPage: React.FC = () => {
  ...
  const handleGoogleOAuth = async () => {
    try {
      ...
      await loginUser(emailToUse, 'user');
    } catch (err: any) {
  ...
  return (
    <div className="flex flex-col flex-1 justify-center py-12 px-4 sm:px-6 lg:px-8 bg-zinc-50 dark:bg-[#091114] transition-colors duration-300">
      <div className="max-w-md w-full mx-auto space-y-6">
        
        {/* Top Header */}
        <div className="text-center space-y-2">
          <div className="mx-auto flex h-24 w-24 md:h-28 md:w-28 items-center justify-center animate-fade-in bg-white dark:bg-white/5 p-2 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-800">
        ...
        {/* Auth Block */}
        <div className="bg-white dark:bg-[#0b1418] border border-slate-200 dark:border-slate-800 p-6 md:p-8 rounded-3xl shadow-md text-left">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-4 border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0b1418] hover:bg-zinc-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-sm rounded-xl shadow-sm cursor-pointer flex items-center justify-center space-x-3 transition active:scale-95"
            >
